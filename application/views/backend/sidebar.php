...
<div class="main-menu"  id="sidebar"><a href="<?php echo base_url('mastercms/home'); ?>" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
    <ul style="display: block;">
        <li class="active"><a href="<?php echo base_url('mastercms/home'); ?>"><i class="icon-home"></i><span>Dashboard</span></a></li>
        <li class="dropdown fadeInDown animated d3">
            <a href="#" class="right-caret"><i class="icon-briefcase"></i> <span>Perusahaan</span> <span><b class="caret mysub-menu"></b></span></a>
                <ul class="firstlevel sub-menu">
                    <li class="twolevel">  <a href="<?php echo base_url('mastercms/perusahaan/cabang'); ?>">Data Perusahaan</a> </li>
                    <li> </li>
                </ul>
        </li>
        <li class="submenu"> <a href="#"><i class="icon-user"></i><span> Karyawan </span> <span><b class="caret mysub-menu"></b></span></a>
            <ul>
                <li><a href="<?php echo base_url('mastercms/karyawan'); ?>"> Data Karyawan </a></li>
            </ul>
        </li>
        <li class="submenu"> <a href="#"><i class="icon-book"></i><span> Laporan </span> <span><b class="caret mysub-menu"></b></span></a>
            <ul>
                <li><a href="<?php echo base_url('mastercms/absensi/summary'); ?>"></i> Ringkasan</a></li>
