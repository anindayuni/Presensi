...
class Mperusahaan extends CI_Model
{
	...
	{
		$id = $_SESSION['user']['perusahaan_id'];
		$this->db->select('l.lokasi_id, l.lokasi_nama,l.perusahaan_title,l.perusahaan_alamat,p.perusahaan_id as perusahaan_id, l.qr_code, count(k.karyawan_id) AS jml_karyawan');
